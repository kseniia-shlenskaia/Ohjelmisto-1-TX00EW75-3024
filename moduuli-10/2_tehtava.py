...
class Building:
    def __init__(self, bottom_floor, top_floor, number_of_elevators):
        ...
        for index in range(number_of_elevators):
            self.list_of_elevators.append(Elevator(bottom_floor, top_floor))
    ...
    def run_elevator(self, number_of_elevator, destination_floor):
        ...
        index_of_elevator = number_of_elevator - 1
        selected_elevator = self.list_of_elevators[index_of_elevator]
